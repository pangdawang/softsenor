...
//const u8* wifista_ssid="TP-LINK_ED12";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
//const u8* wifista_password="13356809957"; 	//连接密码
const u8* wifista_ssid="cisco-public";			//路由器SSID号
//const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="hit_robot"; 	//连接密码
